...
import { ChevronRight, Circle, Plus, X } from "lucide-react";
            ...
            return (
              <FormItem className="flex flex-col gap-2">
                ...
                {radioPlan && (
                  <>
                    <div
                      className="flex items-center gap-1 text-green-main small-text cursor-pointer"
                      onClick={() => setSelectPlanPopupOpen(true)}
                    >
                      プランの詳細を見る <ChevronRight className="w-4 h-4" />
                    </div>
                    {selectPlanPopupOpen && (
