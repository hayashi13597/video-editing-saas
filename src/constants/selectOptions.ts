...
const DELIVERY_FORMAT_OPTIONS = [
  ...
  {
    label: "CMSに直接入稿（WordPressなど）",
    value: "CMSに直接入稿（WordPressなど）"
  }
];
...
const OBJECTIVES_OPTIONS = [
  {
    label: "自動返信による問い合わせ対応",
    value: "自動返信による問い合わせ対応"
  },
  { label: "LINEからの予約／購入導線", value: "LINEからの予約／購入導線" },
  {
    label: "ステップ配信による教育・販売",
    value: "ステップ配信による教育・販売"
  },
  {
    label: "リッチメニューを活用したサービス案内",
    value: "リッチメニューを活用したサービス案内"
  },
  {
    label: "友だち登録キャンペーン／クーポン配布",
    value: "友だち登録キャンペーン／クーポン配布"
  },
...
const SCRIPT_STYLE_OPTIONS = [
  ...
  {
    label: "独白形式（ナレーション・解説）",
    value: "独白形式（ナレーション・解説）"
  },
  { label: "モノローグ＋字幕中心", value: "モノローグ＋字幕中心" },
  {
    label: "お客様の声（架空インタビュー）",
    value: "お客様の声（架空インタビュー）"
  },
  { label: "その他　", value: "その他　" }
];
...
const TONE_PREFERENCE_OPTIONS = [
  ...
  {
    label: "ストーリー仕立て（感動／ビフォーアフター）",
    value: "ストーリー仕立て（感動／ビフォーアフター）"
  },
...
const KEY_ELEMENTS_OPTIONS = [
  ...
  {
    label: "CTA（LINE登録・資料請求・申し込みなど）",
    value: "CTA（LINE登録・資料請求・申し込みなど）"
  }
];
